...
class VisualizationSettingsView(QTabWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.lighting_settings.lighting_changed.connect(self.vis_properties_changed)
        self.geometry_settings.properties_changed.connect(self.vis_properties_changed)
        self.geometry_settings.representation_changed.connect(self.representation_changed.emit)
